...
public class branch_intelligence_update extends javax.swing.JFrame {
    ...
    private String idIntelligence;
    private String idUser;
    private int selectedBranchId;
    private int selectedIntelligenceId;
    private int selectedUserId;
    private int idUserUpdate;
    /**
     * Creates new form branch_intelligence_update
     */
    public branch_intelligence_update() {
        initComponents();
        setLocationRelativeTo(null);
        //branchintelligence.loadUsers(comboBoxUsers, idUser);
    }
    
    //Defino el parent
    public void setParent(branch_intelligence_interface parent){
    ...
    private void initComponents() {
        ...
        comboBoxIntelligence = new javax.swing.JComboBox<>();
        ...
        jLabel1.setText("Modificar la relación");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(177, 177, 177)
                        .addComponent(comboBoxBranch, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(comboBoxIntelligence, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(comboBoxIntelligence, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    // Cargar los datos del "Branch_Intelligence" seleccionado en la interfaz principal
    public void setRelationData(String idBranchIntelligence, String idBranch, String idIntelligence, String idUser){
      ...
      branchintelligence.loadComboBoxData(comboBoxBranch, "branch", "id_branch", "name", null, Branch.class, idBranch);
      branchintelligence.loadComboBoxData(comboBoxIntelligence, "intelligences", "id_intelligences", "name", null, Intelligences.class, idIntelligence);
      branchintelligence.loadComboBoxData(comboBoxUsers, "users", "id_user", "name", null, Users.class, idUser);
      
    }
    
    //Botón "Cancelar", cierra esta ventana
    ...
    //Botón "Modificar", para aplicar los cambios realizados
    private void btn_modifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modifyActionPerformed
        ...
        selectedBranchId = comboBoxBranch.getSelectedIndex();
        System.out.println("ID de la Branch seleccionada: " + selectedBranchId);
        selectedIntelligenceId = comboBoxIntelligence.getSelectedIndex();
        System.out.println("ID de la Intelligence seleccionada: " + selectedIntelligenceId);
        selectedUserId = comboBoxUsers.getSelectedIndex();
        System.out.println("ID del usuario que actualiza: " + selectedUserId);
        branchintelligence.updateRelation(selectedBranchId, selectedIntelligenceId, Integer.parseInt(idBranchIntelligence), selectedUserId, this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(branch_intelligence_update.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new branch_intelligence_update().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> comboBoxIntelligence;
