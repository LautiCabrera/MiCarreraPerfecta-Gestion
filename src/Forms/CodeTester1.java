 ...
 * @author BTF
 */
public class CodeTester1 extends javax.swing.JFrame {
...
//        }
        //<String[]> RSO = JsonDataFetcher.SEND(SS, FF, WW);
...
//            System.out.println(Arrays.toString(RSO.get(i)));
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CodeTester1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CodeTester1().setVisible(true);
            }
        });
    }
