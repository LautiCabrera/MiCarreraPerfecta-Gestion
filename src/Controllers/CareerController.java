...
public abstract class CareerController {
    ...
    public static void createCareer(String name, int title_intermediate, String description, int duration_months, int id_type_career, int id_modality, int id_branch, int id_range) {
        String query = "INSERT INTO career (name, title_intermediate, description, duration_months, id_type_career, id_modality, id_branch, id_branch, id_range, id_user_create, id_user_update, f_create, f_update) VALUES ('"
    ...
    public static void modifyCareer(int id_career, String name, int title_intermediate, String description, int duration_months, int id_type_career, int id_modality, int id_branch, int id_range){
